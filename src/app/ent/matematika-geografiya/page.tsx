...
const ENT_FAQ = [
  ...
  },
  {
    ...
    answer: "Проходной балл ЕНТ зависит от конкурса в текущем году. Минимальный порог для участия в конкурсе устанавливается государством. Точные проходные баллы публикуются приёмной комиссией AlmaU перед началом приёма.",
  },
  {
  ...
  },
  {
    ...
    answer: "Да, государственные гранты выделяются ежегодно на конкурсной основе по результатам ЕНТ для всех программ. Для получения гранта необходимо набрать высокий конкурсный балл. AlmaU также предоставляет собственные внутренние гранты.",
  },
  {
