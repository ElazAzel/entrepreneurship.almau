...
const ENT_SUBJECTS_FAQ = [
  ...
  },
  {
    ...
    acceptedAnswer: {
      "@type": "Answer",
      text: "Минимальный порог ЕНТ для участия в конкурсе устанавливается государством. Проходной балл зависит от программы и конкурса в текущем году. Актуальные значения уточняйте в приёмной комиссии AlmaU.",
    },
  },
];
