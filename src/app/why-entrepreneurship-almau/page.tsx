...
const WHY_FAQ = [
  ...
  },
  {
    ...
    answer: "AlmaU — один из немногих вузов Казахстана с выделенным Институтом предпринимательства. Студенты получают не теорию, а практические навыки: запуск стартапов, работа с бизнес-моделями, управление проектами, нетворкинг с предпринимателями.",
  },
  {
          ...
          <div className="rounded-2xl md:rounded-3xl border border-darkBorder bg-darkCard/80 backdrop-blur-sm overflow-hidden">
            <div className="p-6 md:p-14 text-center">
              ...
              <p className="mt-4 max-w-2xl mx-auto text-sm md:text-base text-textSecondary leading-relaxed break-words">
                AlmaU — университет бизнеса в Алматы с собственным Институтом предпринимательства. Программы International Business, Digital Commerce и BAE — это практическое обучение, запуск стартапов, сообщество предпринимателей и карьера с первого курса.
              </p>
